...
public class Phone {
	...
	// the class is the blue print properties of a class are defined by instance variables.
	// declare an instance variable as Private, data type, attribute.attribute are the same as properties.
	//declare instance variables - properties/attributes
	//weight, height, width, color. //instance variables are declared with the keyword private to prevent them from beign accessed outside the class
	private int weight;
	private int height;
	private int width;
	...
	//Next declare the instance behavior or methods/functionality(void method  means its not returning anything).And methods are usually public
